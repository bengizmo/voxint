...
| [`how-to/`](how-to/README.md) | **Day-to-day task guides** for non-technical operators: add media & manage runs, review & adjudicate, manage speakers & export, translate transcripts, check for AI-generated speech, settings & troubleshooting, and (advanced) changing pipeline models |
...
| `plugins.md` | Plugin author guide: writing, registering, and shipping a plugin |
