"""Migration 0018 (transcript_segments.confidence), up/down + parity (issue #53).
...
def _seed_segment(engine: Engine) -> uuid.UUID:
    """A media_item + pipeline_run + one transcript segment written under 0017
...
def test_migration_0018_roundtrip_preserves_segments(
