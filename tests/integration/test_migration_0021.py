"""Migration 0021 (app_settings feature-flag + external-sources columns), up/down.
...
def test_migration_0021_columns_null_parity_and_roundtrip(
    alembic_cfg: Config, engine: Engine
) -> None:
    # Before: at 0020 none of the new columns exist.
