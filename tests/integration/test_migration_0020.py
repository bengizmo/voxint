"""Migration 0020 (segment_review_states), up/down + constraints (issues #53/#58).
...
def test_migration_0020_table_and_constraints(alembic_cfg: Config, engine: Engine) -> None:
